...
setenv VIRTUAL_ENV '/Users/olga/Olga'"'"'s workspace/ETHZ SBS/Marty project/LLM Frames Design/frame_engine_v1.0.0/code/.venv'
...
if (backend-py3.11 != "") then
    setenv VIRTUAL_ENV_PROMPT backend-py3.11
else
